...
<head>
    ...
    <script src="js/jquery-mask-use.js" type="text/javascript"></script>
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="index.html"><i class="glyphicon glyphicon-home"></i><span> Anasayfa</span></a></li>
                        <li><a class="ajax-link" href="users.php"><i class="glyphicon glyphicon-user"></i><span> Kullanıcılar</span></a></li>
                        <li><a class="ajax-link" href="arizalar.php"><i class="glyphicon glyphicon-user"></i><span> Arızalar</span></a></li>
